...
DEFAULT_OUTPUT_DIR = os.path.join(SCRIPT_PATH, 'C:/Users/stork/Desktop/hangul/tensorflow-hangul-recognition-master/1108')
    ...
    for character in labels:
        ...
        for font in fonts:
            ...
            for i in range(DISTORTION_COUNT):
                ...
                # print("distorted_array : ", distorted_array)
                # 이미 여기서 검은색이 낀 어레이가 넘어오는걸 확인.
