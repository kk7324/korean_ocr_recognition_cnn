#!/usr/bin/env python
# 신경망 수정& 드랍아웃 계층 삭제 시도
# 훈련 성공 Accuracy 90% 이상 / optimized 파일 생성 과정 오류 발생 & 추적
# export_model() 함수 내 파라미터 문제로 추정 됨.
...
DEFAULT_TFRECORDS_DIR = os.path.join(SCRIPT_PATH, 'C:/Users/stork/Desktop/hangul/tensorflow-hangul-recognition-master/tfrecords-output2')
DEFAULT_OUTPUT_DIR = os.path.join(SCRIPT_PATH, 'C:/Users/stork/Desktop/hangultensorflow-hangul-recognition-master/saved-model0906')
...
def export_model(model_output_dir, input_node_names, output_node_name):
    ...
    # 수정
    # input_node_names => [input_node_names] 로 변경
