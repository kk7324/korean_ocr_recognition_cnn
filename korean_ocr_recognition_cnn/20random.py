...
# Default paths.
DEFAULT_LABEL_FILE = os.path.join(SCRIPT_PATH,'C:/gpuTest/labels/512-common-hangul.txt')
DEFAULT_TFRECORDS_DIR = os.path.join(SCRIPT_PATH, 'C:/gpuTest/tfrecords-output')
''' 모델 경로 수정 '''
DEFAULT_OUTPUT_DIR = os.path.join(SCRIPT_PATH, 'C:/gpuTest/random-saved-model')
