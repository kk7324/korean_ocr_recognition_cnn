...
# Default paths.
DEFAULT_LABEL_FILE = os.path.join(SCRIPT_PATH,'C:/Users/stork/Desktop/hangul/tensorflow-hangul-recognition-master/labels/8-common-hangul.txt')
DEFAULT_TFRECORDS_DIR = os.path.join(SCRIPT_PATH, 'C:/Users/stork/Desktop/hangul/tensorflow-hangul-recognition-master/tfrecords-outputsm')
DEFAULT_OUTPUT_DIR = os.path.join(SCRIPT_PATH, 'C:/Users/stork/Desktop/hangul/hangultensorflow-hangul-recognition-master/saved-model-sm')
...
def main(label_file, tfrecords_dir, model_output_dir, num_train_epochs):
    ...
    # h_conv4 = tf.nn.relu(x_conv3 + b_conv3)
    # 수정된 코드, Activation function = Identity
