...
DEFAULT_GRAPH_FILE = os.path.join(
    SCRIPT_PATH, 'C:/Users/stork/Desktop/hangul/tensorflow-hangul-recognition-master/saved-model_final/optimized_hangul_tensorflow.pb'
)
DEFAULT_FILE = os.path.join(
    SCRIPT_PATH, 'C:/Users/stork/Desktop/hangul/tensorflow-hangul-recognition-master/testgenerator/hangul-images/1.jpeg'
)
...
def classify(args):
    ...
    for index in sorted_indices:
        ...
        inndex= int(args.image[95])
        if labels[inndex] == label:
            cnt += 1
        print(cnt)
        print(inndex)
...
if __name__ == '__main__':
    ...
    parser.add_argument('image', type=str, default=DEFAULT_FILE,
